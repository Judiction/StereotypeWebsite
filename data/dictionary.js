...
export const dictionary = {
  "ui": {
    ...
    "tagline": { 
      ...
      "pt": "Artista 3D & Tecnólogo Criativo",
      "fr": "Artiste 3D & Technologue Créatif"
    },

    "intro": {
      "en": "Crafting visual experiences through time and space.",
      "pt": "Criando experiências visuais através do tempo e espaço.",
      "fr": "Créer des expériences visuelles à travers le temps et l'espace."
    },

    "next": { "en": "Next", "pt": "PrÃ³ximo", "fr": "Suivant" },
    ...
    "placeholder_email": { "en": "Email", "pt": "E-mail", "fr": "E-mail" },
    "placeholder_message": { "en": "Message", "pt": "Mensagem", "fr": "Message" },
  ...
  "categories": {
    ...
    "motion-design": { "en": "Motion Design", "pt": "Motion Design", "fr": "Motion Design" },
